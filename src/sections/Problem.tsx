...
export function Problem() {
  return (
    <section
      id="problem"
      className="relative py-24 md:py-32 bg-gradient-problem overflow-hidden"
    >
          ...
          <div>
            ...
            <ScrollReveal delay={0.2}>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                We live in an age of digital abundance, yet our most precious
                moments remain hidden—buried in camera rolls, forgotten in cloud
                storage, lost to the endless scroll.
              </p>
            </ScrollReveal>

            <ScrollReveal delay={0.3}>
              <p className="text-gray-400 mb-10 leading-relaxed">
                The convenience of digital photography has created an unexpected
                paradox: we capture more memories than ever before, but we
                experience fewer of them.
              </p>
            </ScrollReveal>
